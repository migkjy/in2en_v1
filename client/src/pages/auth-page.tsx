      ...
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-blue-500 to-purple-600 items-center justify-center text-white">
        <div className="max-w-lg p-4">
          <div className="text-center">
            <h1 className="text-6xl md:text-7xl font-bold mb-2 tracking-wider text-white uppercase drop-shadow-lg">Welcome to</h1>
            <h1 className="text-6xl md:text-7xl font-bold tracking-wider text-white uppercase drop-shadow-lg animate-pulse">In2English</h1>
          </div>
        </div>
      </div>
