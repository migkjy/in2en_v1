...
const AssignmentDetail = lazy(
  () => import("@/pages/assignments/assignment-detail"),
);
...
const SubmissionDetail = lazy(
  () => import("@/pages/submissions/submission-detail"),
);
    ...
    <Suspense fallback={<div>Loading...</div>}>
      <Switch>
        ...
        <Route
          ...
          component={(props) => (
            <ProtectedRoute component={UploadAssignment} {...props} />
          )}
        />
        <Route
          path="/assignments/:id"
          component={(props) => (
            <ProtectedRoute component={AssignmentDetail} {...props} />
          )}
        />
        <Route
          path="/submissions/:id"
          component={(props) => (
            <ProtectedRoute component={SubmissionDetail} {...props} />
          )}
        />
        ...
        <Route
          ...
          component={(props) => (
            <ProtectedRoute component={CreateAssignment} {...props} />
          )}
        />
        <Route
          path="/admin/assignments/review/:id"
          component={(props) => (
            <ProtectedRoute component={ReviewAssignment} {...props} />
          )}
        />
        <Route
          path="/admin/assignments/:id/upload"
          component={(props) => (
            <ProtectedRoute component={UploadAssignment} {...props} />
          )}
        />
        ...
        <Route
          ...
          component={(props) => (
            <ProtectedRoute component={AssignmentList} {...props} />
          )}
        />
        <Route
          path="/admin/classes/:id"
          component={(props) => (
            <ProtectedRoute component={ClassDetail} {...props} />
          )}
        />
        <Route
          path="/admin/classes"
          component={(props) => (
            <ProtectedRoute component={ClassList} {...props} />
          )}
        />
        <Route
          path="/admin/branches/:id"
          component={(props) => (
            <ProtectedRoute component={BranchDetail} {...props} />
          )}
        />
        <Route
          path="/admin/branches"
          component={(props) => (
            <ProtectedRoute component={BranchList} {...props} />
          )}
        />
        <Route
          path="/admin/teachers/:id"
          component={(props) => (
            <ProtectedRoute component={TeacherDetail} {...props} />
          )}
        />
        <Route
          path="/admin/teachers"
          component={(props) => (
            <ProtectedRoute component={TeacherList} {...props} />
          )}
        />
        <Route
          path="/admin/students"
          component={(props) => (
            <ProtectedRoute component={StudentList} {...props} />
          )}
        />
        ...
        <Route
          path="/teacher"
          component={(props) => (
            <ProtectedRoute component={TeacherDashboard} {...props} />
          )}
        />
        <Route
        ...
        />
        <Route
          path="/teacher/assignments/:id/upload"
          component={(props) => (
            <ProtectedRoute component={UploadAssignment} {...props} />
          )}
        />
        ...
        />
        <Route
          path="/student/assignments/:id/upload"
          component={(props) => (
            <ProtectedRoute component={UploadAssignment} {...props} />
          )}
        />
